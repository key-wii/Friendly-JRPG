/// @desc scr_earthbound_bg_set_stretch_y(instance_id, speed, length, amplitude, phase)
/// @param instance_id
/// @param speed
/// @param length
/// @param amplitude
/// @param phase
function scr_earthbound_bg_set_stretch_y() {
	...
	It will distort the image applying a stretch effect the y coordinates. This will
	...
	speed				real	The speed the effect moves up or down
	...
	------------------------------
		...
		scr_earthbound_bg_set_stretch_y(layer_1, 0.75, 5, 0.3, 0);
	
	This will:
	- create an earthbound-background-instance,
	- sets its sprite to "spr_diamonds",
	- sets a relaxing, slow, small y-stretch distortion

	-----------------------------------------------------------------------------*/

	with (argument[0]) {
		sin_stretch_y_spd	= argument[1];
		sin_stretch_y_len	= argument[2];
		sin_stretch_y_amp	= argument[3];
		sin_stretch_y_phase	= argument[4];
	}
